...
export default function Contact() {
  ...
  return (
    <section id="contact" className="flex flex-col items-center gap-10 py-8">
      <div className="text-center">
        <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-slate-900 dark:text-white mb-4">
          {t.contact.heading}
        </h2>
        <div className="w-16 h-1 bg-fuchsia-600 mx-auto rounded-full mb-6" />
      ...
      <div className="flex flex-wrap justify-center gap-4">
        <a
          href="mailto:ewen.tonnerre@example.com"
          className="h-12 px-6 rounded-full bg-linear-to-r from-fuchsia-600 to-purple-600 text-white text-sm font-medium flex items-center gap-3 hover:opacity-90 transition-opacity shadow-lg shadow-fuchsia-500/20"
        >
          <MailIcon />
          {t.contact.cta}
        </a>
